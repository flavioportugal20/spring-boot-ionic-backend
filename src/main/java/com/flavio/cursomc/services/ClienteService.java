...
public class ClienteService{
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		...
		Endereco e1 = new Endereco(null, objDto.getLogradouro(), objDto.getNumero(), objDto.getComplemento(), objDto.getBairro(), objDto.getCep(), cli, cid);
		
		cli.getEnderecos().add(e1);
